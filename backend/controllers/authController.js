...
export const signupUser = async (req, res) => {
  try {
    ...
    const newUser = await User.create({ 
      ...
      isVerified: false   // 👈 Important: Set isVerified to false on signup
    });
      ...
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f3f4f6; padding: 30px;">
          <div style="max-width: 600px; margin: auto; background: white; padding: 30px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            ...
            <p style="color: #4b5563;">Hello ${name.split(' ')[0]},</p>
            <p style="color: #4b5563;">Please confirm your email by clicking the button below:</p>
            <div style="text-align: center; margin: 30px 0;">
              <a href="${confirmLink}" style="background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none;">Confirm Email</a>
            </div>
